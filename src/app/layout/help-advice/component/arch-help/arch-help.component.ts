          ...
          "children": [
              ...
              "children": [
                {
                  "data": {
                    "name": "style.css",
                    "description": "아이콘 css 파일 - 실제 아이콘 사용 시 필요한 스타일시트가 정의되어 있다."
                  }
                },
                {
                  "data": {
            ...
            },
            {
              ...
              "children": [{
                "data": {
                  "name": "rsm",
                  "description": "RSM 테마 설정 폴더"
                },
                "children": [{
                  "data": {
                    "name": "fonts",
                    "description": "RSM 폰트가 정의된 폴더"
                  }
                },
                {
                  "data": {
                    "name": "images",
                    "description": "테마 설정 시 필요한 이미지들을 모아놓은 폴더"
                  }
                },
                {
                  "data": {
              ...
              },
              {
                "data": {
                  "name": "_theme.scss",
                  "description": "테마 설정 최상위 scss 설정 파일 / [주의] 수정하지 말것."
                }
              }]
            }
          ]
